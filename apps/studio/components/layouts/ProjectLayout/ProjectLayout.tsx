...
import NavigationBarWithProjectSelector from './NavigationBarWithProjectSelector'
import { MultiTenantProjectProvider } from './MultiTenantProjectContext'
    ...
    <AppLayout>
      <MultiTenantProjectProvider>
        ...
        <div className="flex h-full">
          ...
          {!hideIconBar && <NavigationBarWithProjectSelector />}
          {/* Product menu bar */}
          <ResizablePanelGroup
